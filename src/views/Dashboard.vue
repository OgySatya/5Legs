  ...
  <div class="grid mx-auto w-max mt-10">
    <div class="flex justify-between my-4">
      <div class="grid">
        ...
        <input type="date" v-model="startDate" class=" border-4 p-2 rounded-btn border-neutral">
      </div>
      <div class="grid">
        <label class="label">
          <span class="label-text">date end</span>
        </label>
        <input class=" border-4 p-2 rounded-btn border-neutral" type="date" v-model="endDate">
      </div>
