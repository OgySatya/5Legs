...
<template>
  ...
  <section class="grid grid-cols-4 gap-5 m-10">
    <div v-for="(order, index) in orderList" :key="index" class="card bg-base-200 border-4 border-primary w-96 p-5">
      ...
      <div class="card-body">
        ...
        <div class="card-actions justify-end">
          <button @click="detailOrder(order.id)" class="btn btn-primary">Open
            Detail</button>
        </div>
      </div>
    </div>
